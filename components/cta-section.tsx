...
//   return (
//     <section id="aplikacja" className="py-20 px-4">
//       <div className="container mx-auto">
//         <div className="max-w-4xl mx-auto">
//           <div className="bg-gradient-to-r from-amber-500/20 to-amber-600/20 border border-amber-500/30 rounded-3xl p-8 md:p-12 mb-8 text-center relative overflow-hidden">
...
//                 <Button size="lg" className="bg-amber-500 hover:bg-amber-600 text-black font-bold text-lg px-10 py-7">
...
//                   size="lg"
//                   variant="outline"
//                   className="border-white/30 text-white hover:bg-white/10 text-lg px-10 py-7 bg-transparent"
//                 >
